		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['firstkana']) {
					$('#payment-address input[name=\'firstkana\'] + br').after('<span class="error">' + json['error']['firstkana'] + '</span>');
				}
				
				if (json['error']['lastkana']) {
					$('#payment-address input[name=\'lastkana\'] + br').after('<span class="error">' + json['error']['lastkana'] + '</span>');
				}	
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['firstkana']) {
					$('#payment-address input[name=\'firstkana\']').after('<span class="error">' + json['error']['firstkana'] + '</span>');
				}
				
				if (json['error']['lastkana']) {
					$('#payment-address input[name=\'lastkana\']').after('<span class="error">' + json['error']['lastkana'] + '</span>');
				}	
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['firstkana']) {
					$('#shipping-address input[name=\'firstkana\']').after('<span class="error">' + json['error']['firstkana'] + '</span>');
				}
				
				if (json['error']['lastkana']) {
					$('#shipping-address input[name=\'lastkana\']').after('<span class="error">' + json['error']['lastkana'] + '</span>');
				}	
