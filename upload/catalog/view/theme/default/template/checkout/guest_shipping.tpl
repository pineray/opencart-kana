<table class="form">
  ...
  <tr>
    ...
    <td><input type="text" name="lastkana" value="<?php echo $lastkana; ?>" class="large-field" /></td>
  </tr>
  <tr>
    <td><span class="required">*</span> <?php echo $entry_firstkana; ?></td>
    <td><input type="text" name="firstkana" value="<?php echo $firstkana; ?>" class="large-field" /></td>
  </tr>
  <tr>
