  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
      <div class="left">
        ...
        <?php } ?>
        <br />
        <span class="required">*</span> <?php echo $entry_lastkana; ?><br />
        <input type="text" name="lastkana" value="<?php echo $lastkana; ?>" class="large-field" />
        <br />
        <?php if ($error_lastkana) { ?>
        <span class="error"><?php echo $error_lastkana; ?></span>
        <?php } ?>
        <br />
        <span class="required">*</span> <?php echo $entry_firstkana; ?><br />
        <input type="text" name="firstkana" value="<?php echo $firstkana; ?>" class="large-field" />
        <br />
