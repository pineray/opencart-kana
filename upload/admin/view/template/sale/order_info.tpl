    ...
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            ...
            <td><a href="<?php echo $customer; ?>"><?php echo $lastname; ?> <?php echo $firstname; ?></a> (<?php echo $lastkana; ?> <?php echo $firstkana; ?>)</td>
          </tr>
          <?php } else { ?>
          <tr>
            <td><?php echo $text_customer; ?></td>
            <td><?php echo $lastname; ?> <?php echo $firstname; ?> (<?php echo $lastkana; ?> <?php echo $firstkana; ?>)</td>
          </tr>
          <?php } ?>
          ...
          <tr>
            ...
            <td><a href="<?php echo $affiliate; ?>"><?php echo $affiliate_firstname; ?> <?php echo $affiliate_lastname; ?></a> (<?php echo $affiliate_lastkana; ?> <?php echo $affiliate_firstkana; ?>)</td>
          </tr>
          <tr>
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_lastkana; ?></td>
            <td><?php echo $payment_lastkana; ?></td>
          </tr>
          <tr>
            <td><?php echo $text_firstkana; ?></td>
            <td><?php echo $payment_firstkana; ?></td>
          </tr>
      ...
      <div id="tab-shipping" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_lastkana; ?></td>
            <td><?php echo $shipping_lastkana; ?></td>
          </tr>
          <tr>
            <td><?php echo $text_firstkana; ?></td>
            <td><?php echo $shipping_firstkana; ?></td>
          </tr>
