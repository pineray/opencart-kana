        ...
        <div id="tab-general">
          ...
          <div id="tab-address-<?php echo $address_row; ?>" class="vtabs-content">
            ...
            <table class="form">
              ...
              <tr>
                <td><span class="required">*</span> <?php echo $entry_lastkana; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][lastkana]" value="<?php echo $address['lastkana']; ?>" />
                  <?php if (isset($error_address_lastkana[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_lastkana[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
                <td><span class="required">*</span> <?php echo $entry_firstkana; ?></td>
                <td><input type="text" name="address[<?php echo $address_row; ?>][firstkana]" value="<?php echo $address['firstkana']; ?>" />
                  <?php if (isset($error_address_firstkana[$address_row])) { ?>
                  <span class="error"><?php echo $error_address_firstkana[$address_row]; ?></span>
                  <?php } ?></td>
              </tr>
              <tr>
...
function addAddress() {	
    ...
    html += '    </tr>';
    html += '    <tr>';
    html += '      <td><span class="required">*</span> <?php echo $entry_lastkana; ?></td>';
    html += '      <td><input type="text" name="address[' + address_row + '][lastkana]" value="" /></td>';
    html += '    </tr>';
	html += '    <tr>';
    html += '	   <td><span class="required">*</span> <?php echo $entry_firstkana; ?></td>';
    html += '	   <td><input type="text" name="address[' + address_row + '][firstkana]" value="" /></td>';
    html += '    </tr>';
    html += '    <tr>';
