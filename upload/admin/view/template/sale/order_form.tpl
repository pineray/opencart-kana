      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-customer" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_lastkana; ?></td>
              <td><input type="text" name="lastkana" value="<?php echo $lastkana; ?>" />
                <?php if ($error_lastkana) { ?>
                <span class="error"><?php echo $error_lastkana; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_firstkana; ?></td>
              <td><input type="text" name="firstkana" value="<?php echo $firstkana; ?>" />
                <?php if ($error_firstkana) { ?>
                <span class="error"><?php echo $error_firstkana; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
          ...
          <table class="form">
            <tr>
              ...
              <td><select name="payment_address">
                  ...
                  <option value="<?php echo $address['address_id']; ?>"><?php echo $address['lastname'] . ' ' . $address['firstname'] . ', ' . $address['city'] . ', ' . $address['address_1'] . ', ' . $address['country']; ?></option>
                  <?php } ?>
                </select></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_lastkana; ?></td>
              <td><input type="text" name="payment_lastkana" value="<?php echo $payment_lastkana; ?>" />
                <?php if ($error_payment_lastkana) { ?>
                <span class="error"><?php echo $error_payment_lastkana; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_firstkana; ?></td>
              <td><input type="text" name="payment_firstkana" value="<?php echo $payment_firstkana; ?>" />
                <?php if ($error_payment_firstkana) { ?>
                <span class="error"><?php echo $error_payment_firstkana; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_lastkana; ?></td>
              <td><input type="text" name="shipping_lastkana" value="<?php echo $shipping_lastkana; ?>" />
                <?php if ($error_shipping_lastkana) { ?>
                <span class="error"><?php echo $error_shipping_lastkana; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_firstkana; ?></td>
              <td><input type="text" name="shipping_firstkana" value="<?php echo $shipping_firstkana; ?>" />
                <?php if ($error_shipping_firstkana) { ?>
                <span class="error"><?php echo $error_shipping_firstkana; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_company; ?></td>
...
$('input[name=\'customer\']').catcomplete({
	...
	select: function(event, ui) { 
		...
		$('input[name=\'firstkana\']').attr('value', ui.item['firstkana']);
		$('input[name=\'lastkana\']').attr('value', ui.item['lastkana']);
		...
		for (i in  ui.item['address']) {
			html += '<option value="' + ui.item['address'][i]['address_id'] + '">' + ui.item['address'][i]['lastname'] + ' ' + ui.item['address'][i]['firstname'] + ', ' + ui.item['address'][i]['city'] + ', ' + ui.item['address'][i]['address_1'] + ', ' + ui.item['address'][i]['country'] + '</option>';
		}
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
				...
				$('input[name=\'payment_firstkana\']').attr('value', json['firstkana']);
				$('input[name=\'payment_lastkana\']').attr('value', json['lastkana']);
	...
	$.ajax({
		...
		success: function(json) {
			if (json != '') {	
				...
				$('input[name=\'shipping_firstkana\']').attr('value', json['firstkana']);
				$('input[name=\'shipping_lastkana\']').attr('value', json['lastkana']);
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				if (json['error']['firstkana']) {
					$('input[name=\'firstkana\']').after('<span class="error">' + json['error']['firstkana'] + '</span>');
				}
				
				if (json['error']['lastkana']) {
					$('input[name=\'lastkana\']').after('<span class="error">' + json['error']['lastkana'] + '</span>');
				}
				...
				if (json['error']['payment']) {	
					...
					if (json['error']['payment']['firstkana']) {
						$('input[name=\'payment_firstkana\']').after('<span class="error">' + json['error']['payment']['firstkana'] + '</span>');
					}
					
					if (json['error']['payment']['lastkana']) {
						$('input[name=\'payment_lastkana\']').after('<span class="error">' + json['error']['payment']['lastkana'] + '</span>');
					}
				...
				if (json['error']['shipping']) {		
					...
					if (json['error']['shipping']['firstkana']) {
						$('input[name=\'shipping_firstkana\']').after('<span class="error">' + json['error']['shipping']['firstkana'] + '</span>');
					}
					
					if (json['error']['shipping']['lastkana']) {
						$('input[name=\'shipping_lastkana\']').after('<span class="error">' + json['error']['shipping']['lastkana'] + '</span>');
					}
